...
$hora = $_POST['hora'];
$fecha = $_POST['fecha'];
$sqlT = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$hora' AND fecha = '$fecha'";
...
$sql = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$hora' AND fecha = '$fecha' AND tipo_vehiculo = 'Vehículo Liviano'";
...
$sql1 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$hora' AND fecha = '$fecha' AND tipo_vehiculo = 'Vehículo Mediano'";
...
// Filtro hora - VPesado
$sql2 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$hora' AND fecha = '$fecha' AND tipo_vehiculo = 'Vehículo Pesado'";
...
$hora1 = $_POST['hora1'];
$fecha1 = $_POST['fecha1'];
$sqlT1 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$hora1' AND fecha = '$fecha1'";
$totalT1 = $mysqli->query($sqlT1);
$vlT1 = mysqli_num_rows($totalT1);
//Total de Vehiculos 2

// Filtro hora - VLiviano
$sql3 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$hora1' AND fecha = '$fecha1' AND tipo_vehiculo = 'Vehículo Liviano'";
...
// Filtro hora - VMediano
$sql4 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$hora1' AND fecha = '$fecha1' AND tipo_vehiculo = 'Vehículo Mediano'";
...
// Filtro hora - VPesado
$sql5 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$hora1' AND fecha = '$fecha1' AND tipo_vehiculo = 'Vehículo Pesado'";
...
$sqlV = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$horaV' AND fecha = '$fechaV' AND velocidad = '$velocidad'";
$totalV = $mysqli->query($sqlV);
$vlV = mysqli_num_rows($totalV);

$sqlV1 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$horaV1' AND fecha = '$fechaV1' AND velocidad = '$velocidad1'";
$totalV1 = $mysqli->query($sqlV1);
$vlV1 = mysqli_num_rows($totalV1);
//Total de Vehiculos 2

// Filtro hora - VLiviano
$sqlV2 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$horaV' AND fecha = '$fechaV' AND tipo_vehiculo = 'Vehículo Liviano' AND velocidad = '$velocidad'";
$totalV2 = $mysqli->query($sqlV2);
$vlV2 = mysqli_num_rows($totalV2);

$sqlV21 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$horaV1' AND fecha = '$fechaV1' AND tipo_vehiculo = 'Vehículo Liviano' AND velocidad = '$velocidad1'";
...
// Filtro hora - VMediano
$sqlV3 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$horaV' AND fecha = '$fechaV' AND tipo_vehiculo = 'Vehículo Mediano' AND velocidad = '$velocidad'";
$totalV3 = $mysqli->query($sqlV3);
$vlV3 = mysqli_num_rows($totalV3);

$sqlV31 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$horaV1' AND fecha = '$fechaV1' AND tipo_vehiculo = 'Vehículo Mediano' AND velocidad = '$velocidad1'";
...
// Filtro hora - VPesado
$sqlV4 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$horaV' AND fecha = '$fechaV' AND tipo_vehiculo = 'Vehículo Pesado' AND velocidad = '$velocidad'";
$totalV4 = $mysqli->query($sqlV4);
$vlV4 = mysqli_num_rows($totalV4);

$sqlV41 = "SELECT id_vehiculo FROM vehiculos WHERE hora = '$horaV1' AND fecha = '$fechaV1' AND tipo_vehiculo = 'Vehículo Pesado' AND velocidad = '$velocidad1'";
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <form name="Filtro" method="post" action="chartTrafico.php">
                ...
                <div class="card-body">
                  <form name="Filtro" method="post" action="chartTrafico.php">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="DD/MM/AAAA" name="fecha" required>
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="DD/MM/AAAA" name="fecha1" required>
                ...
                <div class="card-body">
                  <form name="Filtro" method="post" action="chartTrafico.php">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="DD/MM/AAAA" name="fechaV" required>
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="DD/MM/AAAA" name="fechaV1" required>
...
<script src="js/chart/trafico/filtroHoraFechaArea.js"></script>
<script src="js/chart/trafico/filtroHoraFechaPie.js"></script>

<script src="js/chart/trafico/comparacionLinear.js"></script>
<script src="js/chart/trafico/comparacionPie.js"></script>

<script src="js/chart/trafico/comparacionLinearV.js"></script>
<script src="js/chart/trafico/comparacionPieV.js"></script>
